            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="space-y-6 text-center md:text-left">
                        ...
                        <p className="text-gray-500 text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
                            Un progetto di Piazza dell&apos;Arte in collaborazione con le Associazioni <strong className="text-gray-400">Morgana</strong> e <strong className="text-gray-400">O.R.U.M.</strong> Portiamo l&apos;arte in gioco.
                        </p>
                        <p className="text-gray-600 text-xs leading-relaxed max-w-xs mx-auto md:mx-0">
                            Dominio gestito da Associazione Morgana. Contitolari del trattamento dati ai sensi dell&apos;art. 26 GDPR.
                        </p>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <nav className="flex flex-col gap-4 text-sm font-bold text-gray-400">
                            ...
                            <Link href="/accordo" className="hover:text-white transition-colors">Accordo di Collaborazione</Link>
                        </nav>
                    </div>
                ...
                <div className="border-t border-gray-800/30 pt-8 text-center space-y-4">
                    ...
                    <div className="flex justify-center gap-6">
                        ...
                        <Link href="/accordo" className="text-gray-700 hover:text-gray-400 text-[10px] uppercase tracking-widest transition-colors">Accordo Collaborazione</Link>
                    </div>
                </div>
            </div>
        </footer>
