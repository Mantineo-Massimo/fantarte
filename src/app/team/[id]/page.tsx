...
export default async function TeamProfilePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main className="min-h-screen text-white pt-56 md:pt-44 pb-32 relative overflow-x-hidden">
            {/* Background Effects */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-oro/5 blur-[80px] rounded-full pointer-events-none"></div>
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                ...
                {/* Artists Section */}
                <div className="mb-16">
                    <h2 className="text-xs font-black uppercase tracking-[0.4em] text-gray-500 mb-8 ml-2">I 5 partecipanti in squadra</h2>
