    ...
    return (
        <motion.div 
            ...
            className={`relative p-10 rounded-[3.5rem] border flex flex-col items-center text-center cursor-pointer group transition-all duration-500
                ${featured 
                    ? "bg-blunotte md:scale-110 md:-translate-y-12 z-20 shadow-[0_30px_100px_rgba(0,0,0,0.8)] border-oro/30 backdrop-blur-3xl" 
                    : "bg-blunotte z-10 border-white/10 backdrop-blur-2xl hover:bg-blunotte/95"}
            `}
        >
